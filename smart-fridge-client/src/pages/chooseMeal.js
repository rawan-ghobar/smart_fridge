...
import { SafeAreaView, View, Text, StyleSheet, TouchableOpacity, Image, Alert, ActivityIndicator } from 'react-native';
...
const ChooseMeal = ({ navigation }) => {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      console.log('Meal Generated:', response.data);
