...
const ChooseCustomizedMeal = ({ navigation }) => {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      // Persist the selection for later use
      await AsyncStorage.setItem('selectedMealType', selectedMeal);

      // Also pass it via params if the next screen prefers that
...
export default ChooseCustomizedMeal;